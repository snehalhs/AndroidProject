...
public class Widget_Setting extends FragmentActivity implements
        ActionBar.TabListener {

    //Snehal AppSectionsPagerAdapter mAppSectionsPagerAdapter;
    ...
    //Snehal static WidgetReceiver wm = new WidgetReceiver();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pagerconfiguration);
        ...
        try {
          ...
          //  Intent intent = new Intent(getApplicationContext(), audiorec.class);
            ...
            //Snehal intent.putExtra("audio", "loc");
            //Snehal startService(intent);
        } catch (Exception e) {
        ...
        /*Snehal mAppSectionsPagerAdapter = new AppSectionsPagerAdapter(
      ...
      //Snehal  mViewPager.setAdapter(mAppSectionsPagerAdapter);
        mViewPager
        ...
        /* Snehal for (int i = 0; i < mAppSectionsPagerAdapter.getCount(); i++) {
        ...
        /*Snehal ig = new Intent(Widget_Setting.this, WidgetReceiver.class);
        ig.setAction("CHANGE_PICTUREG");

        iy = new Intent(Widget_Setting.this, WidgetReceiver.class);
        iy.setAction("CHANGE_PICTUREY");

        ir = new Intent(Widget_Setting.this, WidgetReceiver.class);
     ...
     */
/*  Snehal  public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
     ...
     */
    //
/*   Snehal public static class greenFragment extends Fragment {
